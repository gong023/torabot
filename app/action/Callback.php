 ...
 *  @package    Torabot
 */
class Torabot_Form_Callback extends Torabot_ActionForm
{
	/**
	 *  @access private
 ...
 *  @package	Torabot
 */
class Torabot_Action_Callback extends Torabot_ActionClass
{
	/**
	...
	function perform()
	{
		...
		$tweet = "とららとｾｯ!!for twitter に登録しました。 http://gong023.com/torabot/www/?action_index=true";
		//TODO:完成したら外す
