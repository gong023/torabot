...
require_once 'Torabot_Error.php';
require_once 'Torabot_ActionClass.php';
require_once 'Torabot_ActionForm.php';
require_once 'Torabot_ViewClass.php';

/**
 *  Torabot application Controller definition.
 *
 *  @author     {$author}
 *  @access     public
 *  @package    Torabot
 */
class Torabot_Controller extends Ethna_Controller
{
    /**#@+
     *  @access private
     */
    ...
    var $class = array(
        ...
        'form'          => 'Torabot_ActionForm',
        'i18n'          => 'Ethna_I18N',
        'logger'        => 'Ethna_Logger',
        'plugin'        => 'Ethna_Plugin',
        'session'       => 'Ethna_Session',
        'sql'           => 'Ethna_AppSQL',
        'view'          => 'Torabot_ViewClass',
        'renderer'      => 'Ethna_Renderer_Smarty',
        'url_handler'   => 'Torabot_UrlHandler',
    );
    ...
    var $plugin_search_appids = array(
         ...
         *  2. Torabot_Plugin_Foo_Bar
         *  3. Ethna_Plugin_Foo_Bar
         *
         *  'Common', 'Torabot', 'Ethna',
         */
        'Torabot', 'Ethna',
    );
