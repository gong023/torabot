 ...
 *  @access     public
 */
class Torabot_ActionClass extends Ethna_ActionClass
{
...
//	}
	...
	function insertUser () {
		...
		$query = 'INSERT INTO access_token VALUES (null,"'.$this->access_token.'","'.$this->access_token_secret.'")';
		$this->runQuery($query);
	}
}
// }}}
